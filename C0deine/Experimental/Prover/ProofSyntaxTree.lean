...
| `(>>c0_stmt| $τ:c0_type $x:c0_symbol $ss:c0_stmts <<) =>
    `(Stmt.decl (Typed.mk (c0_type% $τ) (c0_symbol% $x)) >>c0_stmts| $ss <<)
| `(>>c0_stmt| $τ:c0_type $x = $e $ss:c0_stmts <<) =>
    `(Stmt.decl_init (Typed.mk (c0_type% $τ) (c0_symbol% $x)) >>c0_texpr| $e << >>c0_stmts| $ss <<)
| `(>>c0_stmt| $x:c0_symbol : $τ = $e <<) =>
    `(Stmt.assign_var (Typed.mk (c0_type% $τ) (LValue.var (c0_symbol% $x))) >>c0_texpr| $e <<)
